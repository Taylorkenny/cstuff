...
public static void calculateShape() 
{
    while (true)
    {
        ...
        String shapeInput = scan.nextLine();

if (shapeInput.equals("q"))
{
    return;
}

if (shapeInput.equals("square")) 
{
    double sideLength;
...
else if (shapeInput.equals("rectangle")) 
{
    ...
    System.out.println("Enter the length of side a: ");
    lengthA = Double.parseDouble(scan.nextLine());
    System.out.println("Enter the length of side b: ");
    lengthB = Double.parseDouble(scan.nextLine());
    System.out.println("The circumference of the rectangle is: " + (2 * lengthA + 2 * lengthB));
    System.out.println("The area of the rectangle is: " + (lengthA * lengthB));
} 
